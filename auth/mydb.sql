...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Июн 04 2020 г., 00:43
...
ALTER TABLE `last_document_modify`
  ...
  ADD KEY `fk_last_document_modify_modified_by1_idx` (`modified_by_id`);
...
--
ALTER TABLE `document_uploader`
  MODIFY `docupload_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `modified_by`
--
ALTER TABLE `modified_by`
  MODIFY `id_manage` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `document_status`
  ADD CONSTRAINT `fk_document_status_document1` FOREIGN KEY (`document_id`) REFERENCES `document` (`id`),
  ADD CONSTRAINT `fk_document_status_setstatus_by1` FOREIGN KEY (`id_set_by`) REFERENCES `setstatus_by` (`id_status`),
  ADD CONSTRAINT `fk_document_status_status1` FOREIGN KEY (`status_id`) REFERENCES `status` (`id`);

--
-- Ограничения внешнего ключа таблицы `document_type`
--
ALTER TABLE `document_type`
  ADD CONSTRAINT `fk_document_type_document1` FOREIGN KEY (`document_id`) REFERENCES `document` (`id`),
  ADD CONSTRAINT `fk_document_type_type1` FOREIGN KEY (`type_id`) REFERENCES `type` (`id`);

--
-- Ограничения внешнего ключа таблицы `document_uploader`
--
ALTER TABLE `document_uploader`
  ADD CONSTRAINT `fk_document_owner_document1` FOREIGN KEY (`document_id`) REFERENCES `document` (`id`),
  ADD CONSTRAINT `fk_document_owner_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Ограничения внешнего ключа таблицы `last_document_modify`
--
ALTER TABLE `last_document_modify`
  ADD CONSTRAINT `fk_document_modify_document1` FOREIGN KEY (`document_id`) REFERENCES `document` (`id`),
  ADD CONSTRAINT `fk_last_document_modify_modified_by1` FOREIGN KEY (`modified_by_id`) REFERENCES `modified_by` (`id_manage`),
  ADD CONSTRAINT `fk_last_document_modify_modify1` FOREIGN KEY (`modify_id`) REFERENCES `modify` (`id`);

--
-- Ограничения внешнего ключа таблицы `modified_by`
--
ALTER TABLE `modified_by`
  ADD CONSTRAINT `fk_managed_by_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
...
--
ALTER TABLE `setstatus_by`
  ADD CONSTRAINT `fk_setstatus_by_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Ограничения внешнего ключа таблицы `user_role`
--
ALTER TABLE `user_role`
  ADD CONSTRAINT `fk_user_role_role1` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`),
  ADD CONSTRAINT `fk_user_role_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
COMMIT;
