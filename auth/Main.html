...
$result    = mysqli_query($db, "SELECT id FROM user WHERE name='$name' AND    password='$password'"); 
    ...
    <div>
        <div class="header-dark">
            <nav class="navbar navbar-dark navbar-expand-lg navigation-clean-search" id="nbar_m">
                <div class="container"><a id="logo" href="Main.html"><img id="logo" src="assets/img/logo.png" style="width: 80px;"></a><input type="search" id="search-field" class="search-field" name="search"><a id="search1" class="btn btn-light action-button" href="Search.html"><i class="fa fa-search"></i>&nbsp;</a>
                    <a
                        id="admin" class="btn btn-light action-button" href="Adminpanel.html">К панели администратора</a><a class="btn btn-light action-button" href="Upload.html">Загрузить файл</a>
                        ...
                        </div><a class="btn btn-light action-button" role="button" href="Log%20in.html">Вход</a><a class="btn btn-light action-button" role="button" href="Sign%20up.html">Регистрация</a></div>
                        <?endif?>             
            </nav>
