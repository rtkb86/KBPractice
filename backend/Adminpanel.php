...
<table class="table table-hover table-bordered results">
  ...
  <tbody>
    <tr>
      ...
      <td id="tbltext" >Документ №1     
          <a id="abut" class="btn btn-light action-button" role="button">Изменить</a>
          <a id="abut" class="btn btn-light action-button" role="button">Удалить</a></td>
      <td id="tbltext" >25.05.2020</td>
      <td id="tbltext" >Подтвержден</td>
    </tr>
    <tr>
      <th id="tbltext" scope="row">2</th>
      <td id="tbltext" >Документ №2
          <a id="abut" class="btn btn-light action-button" role="button">Изменить</a>
        <a id="abut" class="btn btn-light action-button" role="button">Удалить</a>
        <a id="abut" class="btn btn-light action-button" role="button">Утвердить</a></td>
      <td id="tbltext" >25.05.2020</td>
      <td id="tbltext" >Не подтвержден</td>
    </tr>
    <tr>
      <th id="tbltext" scope="row">3</th>
      <td id="tbltext" >Документ №3 
       <a id="abut" class="btn btn-light action-button" role="button">Изменить</a>
        <a id="abut" class="btn btn-light action-button" role="button">Удалить</a>
          <a id="abut" class="btn btn-light action-button" role="button">Утвердить</a> </td>
      <td id="tbltext" >25.05.2020</td>
...
if ($val[2] == 2){
    ...
    foreach ($val as $value) { 
        if ($value == 'Пользователь'){
            echo '<td>'.$value."\n";
            echo '<form action="change.php" method="post"><input name='."$val[1]".' id="abut" class="btn btn-light action-button" value="Повысить" type="submit"></td></form>'."\n";
        } else {
