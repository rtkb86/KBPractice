        ...
        <div class="header-dark">
            <nav class="navbar navbar-dark navbar-expand-lg navigation-clean-search" id="nbar_m">
                <div class="container">
                  ...
                  <button id="search1" type = "submit" class="btn btn-light action-button" >
                  ...
                  <?endif?>
                  <?if (isset($id)):?>
                  <a class="btn btn-light action-button" href="Upload.php">Загрузить файл</a>
                  <?endif?>
                  <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    <?else:?>
                      <a class="btn btn-light action-button" role="button"  ><?php echo 'Вы вошли как '.$myrow['username']?></a>
